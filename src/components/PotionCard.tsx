...
const PotionCard: React.FC<CardProps> = ({ potion, onClick }) => (
    ...
    <img className="w-full h-64 object-cover mt-4" src={potion.image}/>
      ...
      <p className="text-center mt-2">Boss: {potion.meta.availability.drop_rate.boss}</p>
      <p className="text-center mt-2">Drop-percentage: {potion.meta.availability.drop_rate.chance}</p>
      <div className="p-4">
